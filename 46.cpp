...
在选题之前，我们对题目进行了盲审，并定出了每道题的难度系统。一场考试包含3道开放性题目，
...
/*
思路：将输入数组按从小到大排序，如果相邻两个数小于10，则统计下来，为3个一组，如果相邻两个数大于10则要添加一个数
遍历数组找出相邻两个数差值大于10的个数，将这个数和n相加然后对3取模，差几个补几个就行了
*/
int main()
{
    int n;
